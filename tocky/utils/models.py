...
class LLMModel:
    ...
    def compute_price(self, usage: CompletionUsage) -> int:
        """
        Compute the price for a given number of input and output tokens.

        Returns price in micropennies to avoid floating point issues.
        """
...
LLM_MODELS: list[LLMModel] = [
    ...
    LLMModel(
        provider="openai",
        model="gpt-5",
        input_price_pm=1_25_00,
        cached_input_price_pm=12_50,
        output_price_pm=10_00_00,
    ...
    LLMModel(
        provider="openai",
        model="gpt-5-mini",
        input_price_pm=25_00,
        cached_input_price_pm=2_50,
        output_price_pm=2_00_00,
        supports_temperature=False,
        can_input_images=True,
        supports_reasoning=True,
        context_window_tokens=400_000,
    ...
    LLMModel(
        ...
        model="gpt-5-nano",
        input_price_pm=5_00,
        cached_input_price_pm=50,
        output_price_pm=40_00,
        supports_temperature=False,
        can_input_images=True,
        supports_reasoning=True,
        context_window_tokens=400_000,
    ...
    LLMModel(
        provider="openai",
        model="gpt-4.1",
        input_price_pm=2_00_00,
        cached_input_price_pm=50_00,
        output_price_pm=8_00_00,
        can_input_images=True,
    ...
    LLMModel(
        provider="openai",
        model="gpt-4.1-mini",
        input_price_pm=40_00,
        cached_input_price_pm=10_00,
        output_price_pm=1_60_00,
        can_input_images=True,
        context_window_tokens=1_047_576,
        max_output_tokens=32_768,
        knowledge_cutoff=d("2024-06-01"),
    ...
    LLMModel(
        ...
        input_price_pm=75_00_00,
        cached_input_price_pm=37_50_00,
        output_price_pm=1_50_00_00,
        can_input_images=True,
        is_deprecated=True,
    ...
    LLMModel(
        provider="openai",
        model="gpt-4o",
        input_price_pm=2_50_00,
        cached_input_price_pm=1_25_00,
        output_price_pm=10_00_00,
        can_input_images=True,
        context_window_tokens=128_000,
        max_output_tokens=16_384,
    ...
    LLMModel(
        provider="openai",
        model="gpt-4o-mini",
        input_price_pm=15_00,
        cached_input_price_pm=7_50,
        output_price_pm=60_00,
        can_input_images=True,
        context_window_tokens=128_000,
        max_output_tokens=16_384,
        knowledge_cutoff=d("2023-10-01")
    ...
    LLMModel(
        provider="openai",
        model="o1",
        input_price_pm=15_00_00,
        cached_input_price_pm=7_50_00,
        output_price_pm=60_00_00,
        can_input_images=True,
        supports_reasoning=True,
    ...
    LLMModel(
        provider="openai",
        model="o1-pro",
        input_price_pm=150_00_00,
        cached_input_price_pm=None,
        output_price_pm=600_00_00,
        can_input_images=True,
    ...
    LLMModel(
        provider="openai",
        model="o3-pro",
        input_price_pm=20_00_00,
        cached_input_price_pm=None,
        output_price_pm=80_00_00,
        can_input_images=True,
        supports_reasoning=True,
        context_window_tokens=200_000,
        max_output_tokens=100_000,
    ...
    LLMModel(
        provider="openai",
        model="o4-mini",
        input_price_pm=1_10_00,
        cached_input_price_pm=27_50,
        output_price_pm=4_40_00,
        supports_temperature=False,
        can_input_images=True,
        supports_reasoning=True,
        context_window_tokens=200_000,
    ...
    LLMModel(
        ...
        input_price_pm=1_25_00,
        cached_input_price_pm=1_25_00,  # Unknown, using same as input
        output_price_pm=10_00_00,
        can_input_images=True,
    ...
    LLMModel(
        ...
        input_price_pm=30_00,
        cached_input_price_pm=30_00,  # Unknown?
        output_price_pm=2_50_00,
        can_input_images=True,
        can_input_audio=True,
        supports_reasoning=True,
        context_window_tokens=1_048_576,
